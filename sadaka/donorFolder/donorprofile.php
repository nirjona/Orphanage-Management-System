<?php
  ...
  $myid = $_SESSION['myid'];
  $sql = "select * from DONOR where EMPLOYEE_ID ='$myid'";

  $donor_id = $_GET['did'];
  $donor_name= $_GET['dname'];
 
  $donor_account = $_GET['daccount'];
  $donor_phone=$_GET['dphone'];
 
  $donation_frequency=$_GET['dfrequency'];
...
<div class="container">
    ...
    <?php
    $did=$donor_id;
    include "../donorOwnFolder/donation_records.php";
